...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>f:Signature/f:type</sch:title>
    <sch:rule context="f:Signature/f:type">
  ...
  <sch:pattern>
    <sch:title>f:Signature/f:who</sch:title>
    <sch:rule context="f:Signature/f:who">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Signature/f:who/f:identifier</sch:title>
    <sch:rule context="f:Signature/f:who/f:identifier">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
